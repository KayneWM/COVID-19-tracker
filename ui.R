           ...
           mainPanel(
             ...
             tabsetPanel(type = "tabs",
                         ...
                         tabPanel("Instructions", 
                                  ...
                                  h2('Instructions for Top 10 auto plots'),
                            ...
                            The data table will autopopulate based on the manual plot choices."),
                                  ...
                                  h4("For US counties and states, there are a series of automated plots that filter the data by 'Top 10' categories, such as cases, deaths, etc. Choose a Top 10 plot to see the results. 
                                     Ensure that the appropriate plot tab is chosen (county or state) depending on the choice bar you are using."),
